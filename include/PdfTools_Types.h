...
/**
 */
typedef enum TPdfToolsDocumentAssembly_PageRotation
{
    /**
    No rotation is applied.

     */
    ePdfToolsDocumentAssembly_PageRotation_NoRotation = 0,
    /**
    Rotation for 90 degrees clockwise.

     */
    ePdfToolsDocumentAssembly_PageRotation_Clockwise90 = 1,
    /**
    Rotation for 180 degrees clockwise.

     */
    ePdfToolsDocumentAssembly_PageRotation_Clockwise180 = 2,
    /**
    Rotation for 270 degrees clockwise.

     */
    ePdfToolsDocumentAssembly_PageRotation_Clockwise270 = 3,
...
/**
 */
typedef enum TPdfToolsPdfAConversion_InvoiceType
{
    /**
    ZUGFeRD (version and profile are determined automatically).

     */
    ePdfToolsPdfAConversion_InvoiceType_Zugferd = 1,
    /**
    Factur-X (version and profile are determined automatically).

     */
    ePdfToolsPdfAConversion_InvoiceType_FacturX = 2,
 ...
 */
typedef enum TPdfToolsPdfAConversion_AFRelationship
{
    /**
     */
    ePdfToolsPdfAConversion_AFRelationship_Source = 1,
    /**
     */
    ePdfToolsPdfAConversion_AFRelationship_Data = 2,
    /**
     */
    ePdfToolsPdfAConversion_AFRelationship_Alternative = 3,
    /**
     */
    ePdfToolsPdfAConversion_AFRelationship_Supplement = 4,
    /**
     */
...
typedef enum TPdfToolsOptimizationProfiles_ProfileType
{
    ...
    ePdfToolsOptimizationProfiles_ProfileType_Mrc
...
/**
 * \class TPdfToolsOptimizationProfiles_Mrc
 * @brief The optimization profile suitable for documents with Mixed Raster Content
Reduce the file size for documents containing large images, e.g. scanned pages, while maintaining the readability of
text. This is accomplished by separating the images into a foreground, background and a mask layer. The foreground and
background layers are heavily down-sampled and compressed. The textual information is stored in the mask with a lossless
compression type. Additionally, redundant objects are removed, resources are optimized and embedded fonts are merged.
