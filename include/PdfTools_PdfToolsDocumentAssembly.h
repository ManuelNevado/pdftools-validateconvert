...
/**
 * @brief Specify how page(s) should be rotated.


Default: \ref ePdfToolsDocumentAssembly_PageRotation_NoRotation ""
 ...
 */
PDFTOOLS_EXPORT TPdfToolsDocumentAssembly_PageRotation PDFTOOLS_CALL
PdfToolsDocumentAssembly_PageCopyOptions_GetPageRotation(TPdfToolsDocumentAssembly_PageCopyOptions* pPageCopyOptions);
/**
 * @brief Specify how page(s) should be rotated.
...
* @param[in] iPageRotation Set value.
 ...
 */
PDFTOOLS_EXPORT BOOL PDFTOOLS_CALL PdfToolsDocumentAssembly_PageCopyOptions_SetPageRotation(
    TPdfToolsDocumentAssembly_PageCopyOptions* pPageCopyOptions, TPdfToolsDocumentAssembly_PageRotation iPageRotation);
